...
createUser.prototype.addIt = function () {
    this.price++
}

createUser.prototype.printMe = function () {
    console.log(`Hello ${this.name} Price is ${this.price}`);
}

const tea = new createUser("Arbaj" , 50)
const coffee = createUser("junaid" , 150)
...
of the constructor function. This means that it has access to properties 
